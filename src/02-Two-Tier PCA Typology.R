...
p <- p + annotate("text", x = -1.3, y = -5, label = "Fragile Cutoff", size = 3, angle = 90)
...
pos <- as.numeric(rownames(two.lists)) < nrow(two.lists)/3  #Take top third
...
ggsave(p, filename = "./graphs/Fig 3-1 56 Fragile Situations.pdf", height = 8, width = 10)
